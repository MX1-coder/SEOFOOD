...
'byconsolewooodt_widget_pickup_location'=>''
	...
	//redefine cookie to to handle instant update of order type in settings panel
...
$current_page = get_current_screen();
    ...
    if ( strpos($current_page->base, 'byconsolewooodt_general_settings') !== false || strpos($current_page->base, 'byconsolewooodt_admin_modification_request_settings') !== false || strpos($current_page->base, 'byconsolewooodt_admin_holiday_settings') !== false || strpos($current_page->base, 'byconsolewooodt_wooodt_location_settings_page') !== false) {

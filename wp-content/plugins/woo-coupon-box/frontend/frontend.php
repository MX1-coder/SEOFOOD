...
class VI_WOO_COUPON_BOX_Frontend_Frontend {
	...
	public function wcb_email() {
		...
		if ( $g_validate_response && $this->settings->get_params( 'wcb_recaptcha' ) ) {
			...
			if ( $err ) {
				...
				if ( $this->settings->get_params( 'wcb_recaptcha_version' ) == 2 ) {
					...
					if ( $g_score < 0.5 ) {
						$msg['status']  = 'invalid';
						$msg['warning'] = esc_html__( '*reCAPTCHA score ' . $g_score . ' lower than threshold 0.5 ', 'woo-coupon-box' );
						$msg['message'] = $data;
						wp_send_json( $msg );
						die();
					}
		...
		ob_start();
		?>
        <div class="wcb-footer-text-after-subscribe"><?php esc_html_e( $wcb_footer_text_after_subscribe ) ?></div>
		<?php
...
// Insert the post into the database
			...
			if ( $coupon_select == 'non' ) {
				...
				if ( $show_coupon ) {
					...
					?>
                    <div class="wcb-coupon-treasure-container">
                        <input type="text" readonly="readonly" value="<?php echo $code; ?>"
                               class="wcb-coupon-treasure"/>
                    </div>
                    <span class="wcb-guide">
						<?php esc_html_e( 'Enter this promo code at checkout page.', 'woo-coupon-box' ) ?>
	...
	public function enqueue_scripts() {
		...
		if ( $this->settings->get_params( 'wcb_recaptcha' ) ) {
			if ( $this->settings->get_params( 'wcb_recaptcha_version' ) == 2 ) {
				?>
                <script src='https://www.google.com/recaptcha/api.js?hl=<?php esc_attr_e( get_locale() ) ?>&render=explicit' async
                        defer></script>
				<?php
			} elseif ( $this->settings->get_params( 'wcb_recaptcha_site_key' ) ) {
				?>
                <script src="https://www.google.com/recaptcha/api.js?hl=<?php esc_attr_e( get_locale() ) ?>&render=<?php echo $this->settings->get_params( 'wcb_recaptcha_site_key' ); ?>"></script>
				<?php
			}
		}
	}
	...
	protected function get_socials() {
		...
		if ( $facebook_url ) {
            ...
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="//www.facebook.com/<?php esc_attr_e( $facebook_url ) ?>"
                                                 class="wcb-social-button wcb-facebook"
                                                 title="<?php esc_html_e( 'Follow Facebook', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $facebook_select ) ?>"></span></a>
		...
		if ( $twitter_url ) {
			...
			?>
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="//twitter.com/<?php esc_attr_e( $twitter_url ) ?>"
                                                 class="wcb-social-button wcb-twitter"
                                                 title="<?php esc_html_e( 'Follow Twitter', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $twitter_select ) ?>"></span>
            </a>
			<?php
		...
		if ( $pinterest_url ) {
			...
			?>
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="//www.pinterest.com/<?php esc_attr_e( $pinterest_url ) ?>"
                                                 class="wcb-social-button wcb-pinterest"
                                                 title="<?php esc_html_e( 'Follow Pinterest', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $pinterest_select ) ?>"></span>
            </a>
			<?php
		...
		if ( $instagram_url ) {
			...
			?>
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="//www.instagram.com/<?php esc_attr_e( $instagram_url ) ?>"
                                                 class="wcb-social-button wcb-instagram"
                                                 title="<?php esc_html_e( 'Follow Instagram', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $instagram_select ) ?>"></span>
            </a>
			<?php
		...
		if ( $dribbble_url ) {
			...
			?>
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="//dribbble.com/<?php esc_attr_e( $dribbble_url ) ?>"
                                                 class="wcb-social-button wcb-dribbble"
                                                 title="<?php esc_html_e( 'Follow Dribbble', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $dribbble_select ) ?>"></span>
            </a>
			<?php
		...
		if ( $tumblr_url ) {
			...
			?>
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="//www.tumblr.com/follow/<?php esc_attr_e( $tumblr_url ) ?>"
                                                 class="wcb-social-button wcb-tumblr"
                                                 title="<?php esc_html_e( 'Follow Tumblr', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $tumblr_select ) ?>"></span>
            </a>
			<?php
		...
		if ( $google_url ) {
			...
			?>
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="//plus.google.com/+<?php esc_attr_e( $google_url ) ?>"
                                                 class="wcb-social-button wcb-google-plus"
                                                 title="<?php esc_html_e( 'Follow Google Plus', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $google_select ) ?>"></span>
            </a>
			<?php
		...
		if ( $vkontakte_url ) {
			...
			?>
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="//vk.com/<?php esc_attr_e( $vkontakte_url ) ?>"
                                                 class="wcb-social-button wcb-vk"
                                                 title="<?php esc_html_e( 'Follow VK', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $vkontakte_select ) ?>"></span>
            </a>
			<?php
		...
		if ( $linkedin_url ) {
			...
			?>
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="//www.linkedin.com/in/<?php esc_attr_e( $linkedin_url ) ?>"
                                                 class="wcb-social-button wcb-linkedin"
                                                 title="<?php esc_html_e( 'Follow Linkedin', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $linkedin_select ) ?>"></span>
            </a>
			<?php
		...
		if ( $youtube_url ) {
			...
			?>
            <a <?php if ( $link_target == '_blank' )
				esc_attr_e( 'target=_blank' ) ?> href="<?php echo esc_url_raw( $youtube_url ) ?>"
                                                 class="wcb-social-button wcb-youtube"
                                                 title="<?php esc_html_e( 'Follow Youtube', 'woo-coupon-box' ) ?>">
                <span class="wcb-social-icon <?php esc_attr_e( $youtube_select ) ?>"></span>
            </a>
			<?php

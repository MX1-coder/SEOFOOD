...
class VI_WOO_COUPON_BOX_Frontend_Shortcode {
	...
	public function register_shortcode( $atts ) {
		...
		if ( ! wp_script_is( 'wcbwidget-shortcode-script' ) ) {
			...
			/*button subscribe*/
			$bt_color            = $bt_color ?: $this->settings->get_params( 'wcb_button_text_color' );
			$bt_bg_color         = $bt_bg_color ?: $this->settings->get_params( 'wcb_button_bg_color' );
			$bt_border_radius    = $bt_border_radius ?: $this->settings->get_params( 'wcb_button_border_radius' );
			$input_border_radius = $input_border_radius ?: $this->settings->get_params( 'wcb_email_input_border_radius' );
		...
		ob_start();
		?>
        <div class="woo-coupon-box-widget woo-coupon-box-widget-type-<?php echo $type; ?>">
                ...
                <div class="wcbwidget-newsletter">
                        ...
                        <div class="wcbwidget-input-group">
                            ...
                            <div class="wcbwidget-input-group-btn">
                                <span class="wcbwidget-btn wcbwidget-btn-primary wcbwidget-button" data-show_coupon="<?php echo esc_attr( $show_coupon_code ) ?>">
                                    <?php echo $this->settings->get_params( 'wcb_button_text' ) ?></span>
                            </div>
                        </div>
                    </div>
					<?php
					if ( $this->settings->get_params( 'wcb_gdpr_checkbox' ) ) {
                        ...
                        <div class="wcbwidget-gdpr-field">
                            ...
                            <span class="wcbwidget-gdpr-message"><?php echo $this->settings->get_params( 'wcb_gdpr_message' ); ?></span>
                        </div>
						<?php
					}
					?>
...
// Insert the post into the database
			...
			if ( $show_coupon_code ) {
                ...
                <div class="wcb-coupon-treasure-container">
                    <span class="wcb-coupon-scissors"><input type="text" readonly="readonly" value="<?php echo $code; ?>" class="wcb-coupon-treasure"/></span>
                    <div class="wcb-guide">

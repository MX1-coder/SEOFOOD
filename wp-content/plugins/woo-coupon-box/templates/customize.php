...
?>
<!--template 1-->
<div class="wcb-md-modal wcb-coupon-box wcb-coupon-box-1 wcb-current-layout <?php esc_attr_e( $wcb_popup_type ); ?>"
     id="vi-md_wcb">
    <div class="wcb-content-wrap">
        <span class="wcb-md-close <?php esc_attr_e( $wcb_button_close ) ?>"></span>

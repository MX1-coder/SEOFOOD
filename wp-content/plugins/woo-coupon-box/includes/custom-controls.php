	...
	class WOO_COUPON_BOX_Radio_Icons_Control extends WP_Customize_Control {
		...
		public function render_content() {
            ...
            <div class="customize-control-content">
				...
				$class = str_replace( ']', '', $class );
				?>
                <div class="wcb-radio-icons-wrap <?php esc_attr_e( $class ); ?>">
					<?php
					foreach ( $this->choices as $key => $value ) {
						?>
                        <label class="wcb-radio-icons-label <?php if ( $key == $this->value() )
							esc_attr_e( 'wcb-radio-icons-active' ) ?>">
            ...
            <div class="customize-control-content">
                ...
                <ul class="wcb-features-list-wrap">
					...
					foreach ( $this->choices as $key => $value ) {
						?>
                        <li>
                            <a class="wcb-features-list-item" target="_blank"
                               href="https://1.envato.market/DzJ12"><?php echo $value; ?></a>
                        </li>
						<?php
					}
					?>

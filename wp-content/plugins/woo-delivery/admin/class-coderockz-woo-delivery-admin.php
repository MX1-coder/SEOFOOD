	...
	public function coderockz_woo_delivery_get_deactivate_reasons() {
		...
		$reasons = array(
			array(
				...
				'text'        => __('I couldn\'t understand how to make it work','woo-delivery'),
				'type'        => 'textarea',
				'placeholder' => __('Would you like us to assist you?','woo-delivery')
			),
			array(
				'id'          => 'found-better-plugin',
				'text'        => __('I found a better plugin','woo-delivery'),
				'type'        => 'text',
				'placeholder' => __('Which plugin?','woo-delivery')
			),
			array(
				'id'          => 'not-have-that-feature',
				'text'        => __('I need specific feature that you don\'t support','woo-delivery'),
				'type'        => 'textarea',
				'placeholder' => __('Could you tell us more about that feature?','woo-delivery')
			),
			array(
				'id'          => 'is-not-working',
				'text'        => __('The plugin is not working','woo-delivery'),
				'type'        => 'textarea',
				'placeholder' => __('Could you tell us a bit more whats not working?','woo-delivery')
			),
			array(
				'id'          => 'temporary-deactivation',
				'text'        => __('It\'s a temporary deactivation','woo-delivery'),
				'type'        => '',
				'placeholder' => ''
			),
			array(
				'id'          => 'other',
				'text'        => __('Other','woo-delivery'),
				'type'        => 'textarea',
				'placeholder' => __('Could you tell us a bit more?','woo-delivery')
			),
		);
		...
		<div class="coderockz_woo_delivery_deactive_plugin-modal" id="coderockz_woo_delivery_deactive_plugin-modal">
			<div class="coderockz_woo_delivery_deactive_plugin-modal-wrap">
				<div class="coderockz_woo_delivery_deactive_plugin-modal-header">
					<h2 style="margin:0;"><span class="dashicons dashicons-testimonial"></span><?php _e( ' QUICK FEEDBACK', 'woo-delivery'); ?></h2>
				</div>

				<div class="coderockz_woo_delivery_deactive_plugin-modal-body">
					<p style="font-size:15px;font-weight:bold"><?php _e( 'If you have a moment, please share why you are deactivating Our plugin', 'woo-delivery' ); ?></p>
					<ul class="reasons">
				...
				<div class="coderockz_woo_delivery_deactive_plugin-modal-footer">
					<a href="#" class="coderockz-woo-delivery-skip-deactivate"><?php _e( 'Skip & Deactivate', 'woo-delivery' ); ?></a>
					<div style="float:left">
					<button class="coderockz-woo-delivery-deactivate-button button-primary"><?php _e( 'Submit & Deactivate', 'woo-delivery' ); ?></button>
					<button class="coderockz-woo-delivery-cancel-button button-secondary"><?php _e( 'Cancel', 'woo-delivery' ); ?></button>
					</div>
				</div>
			</div>
		</div>

...
class LDDFW_Orders
{
    ...
    public function lddfw_orders_count_query( $driver_id )
    {
        ...
        if ( false === $orders_count ) {
            $orders_count = $wpdb->get_results( $wpdb->prepare( 'select post_status , count(*) as orders from ' . $wpdb->prefix . 'posts p
    ...
    public function lddfw_out_for_delivery( $driver_id )
    {
        ...
        if ( $wc_query->have_posts() ) {
            ...
            while ( $wc_query->have_posts() ) {
                ...
                $html .= '<a class="lddfw_order_address" href="' . esc_url( lddfw_drivers_page_url( 'lddfw_screen=order&lddfw_orderid=' . $orderid ) ) . '">' . $shipping_address . '</a>';
                if ( '' !== $distance ) {
    ...
    public function lddfw_failed_delivery( $driver_id )
    {
        ...
        if ( $wc_query->have_posts() ) {
            ...
            while ( $wc_query->have_posts() ) {
                ...
                $html .= '<a class="btn lddfw_order_view btn-secondary btn-sm" href="' . esc_url( lddfw_drivers_page_url( 'lddfw_screen=order&lddfw_orderid=' . $orderid ) ) . '">' . esc_html( __( 'Order #', 'lddfw' ) ) . $orderid . '</a>';
                $html .= '<a class="lddfw_order_address line" href="' . lddfw_drivers_page_url( 'lddfw_screen=order&lddfw_orderid=' . $orderid ) . '">' . $shipping_address . '</a>';
                if ( '' !== $distance ) {
    ...
    public function lddfw_delivered( $driver_id )
    {
        ...
        if ( $wc_query->have_posts() ) {
            ...
            while ( $wc_query->have_posts() ) {
                ...
                $html .= '<a class="lddfw_order_address lddfw_line" href="' . lddfw_drivers_page_url( 'lddfw_screen=order&lddfw_orderid=' . $orderid ) . '">' . $shipping_address . '</a>';
                if ( '' !== $distance ) {
                    $html .= '<a class="lddfw_order_distance lddfw_line" href="' . lddfw_drivers_page_url( 'lddfw_screen=order&lddfw_orderid=' . $orderid ) . '">' . esc_html( __( 'Distance', 'lddfw' ) ) . ': ' . $distance . '</a>';
                }
                if ( '' !== $delivered_date ) {

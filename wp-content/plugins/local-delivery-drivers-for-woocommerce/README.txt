...
* The video includes premium features.
## Improve the way you deliver, manage drivers, assign drivers to orders, send SMS and email notifications, routes planning, navigation & more!
...
SMS notifications are sending with the Twilio SMS provider.

* SMS to the delivery driver when a new order is assigned.
* SMS to the customer when the order is out for delivery.
...
* Fix: Currency Format.
* Fix: Payment method title.
* Add: Customer email on the driver panel at the customer info.
* Add: 2 google API keys for application restrictions.
